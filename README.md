...
В [renders/](renders/) лежат заранее отрисованные PNG-скриншоты
...
именем, что и у исходной диаграммы. После изменения PlantUML-исходника
соответствующий PNG нужно перерендерить локально.
