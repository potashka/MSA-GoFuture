...
квалификации, подтверждения local legal counsel и настройки допустимого
...
- PostgreSQL promotion разрешён только после fencing старого primary:
...
- **Полностью автоматический cross-border failover региона без участия
  ...
  policy, если передача не квалифицирована local legal counsel, и создать
